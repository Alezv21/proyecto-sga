...
<body>
    ...
    <div class="container is-fluid">
        <div class="col-xs-12">
            ...
            <h1 style="color:#FF0000">Lista de estudiantes</h1>
            <br>
                            ...
                            <div id="login-row" class="row justify-content-center align-items-center">
                                <div id="login-column" class="col-md-6">
                                    <div id="login-box" class="col-md-12">
                                        ...
                                        <br>
                                        <br>
                                        <h3 class="text-center" style="color:#FF0000">Agregar Nuevo estudiante</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="sexo" name="sexo" class="form-control" required>
                                                <option value="masculino"
                                                    <?php echo ($estudiante['sexo'] == 'masculino') ? 'selected' : ''; ?>>
                                                    Masculino</option>
                                                <option value="femenino"
                                                    <?php echo ($estudiante['sexo'] == 'femenino') ? 'selected' : ''; ?>>
                                                    Femenino</option>
                                            </select>
                                        </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-warning"
                        href="editar_estudiante.php?id_estudiante=<?php echo $fila['id_estudiante'] ?> ">
                        <i class="fa fa-edit"></i> </a>


                    <a class="btn btn-danger btn-del"
                        href="eliminar_estudiante.php?id_estudiante=<?php echo $fila['id_estudiante'] ?> ">
