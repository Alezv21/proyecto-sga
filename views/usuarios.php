...
<body>
    ...
    <div class="container is-fluid">
        <div class="col-xs-12">
            <h1>SISTEMA DE GESTION DE ALERTAS TEMPRANAS USUARIO: <?php echo $_SESSION['nombre']; ?></h1>
            <h1>Lista de usuarios</h1>
            <br>
            <div>
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#create">
                    <span class="glyphicon glyphicon-plus"></span> Nuevo registro <i class="fa fa-plus"></i> </button>
