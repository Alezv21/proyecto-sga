...
function Header()
{
    ...
    // Título
    $this->Cell(70,10,'Registro',0,0,'C');
    // Salto de línea
    ...
    $this->Cell(40,10,'Auditoria',1,0,'C',0,);
...
$consulta = "SELECT docente.id, docente.nombre, docente.fecha_nacimiento, docente.auditoria_fecha, docente.rol FROM docente
LEFT JOIN docente ON docente.rol = docente.id";
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->Cell(40,10,$row['auditoria_fecha'],1,0,'C',0);
